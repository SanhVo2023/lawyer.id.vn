...
const ecosystemLinks = [
  { label: 'Apolo Lawyers', href: 'https://apololawyers.com', description: 'Our firm' },
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-white/60">
              <div>
                <p className="font-medium text-white/80 mb-1">Head Office</p>
                <p>108 Tran Dinh Xu, Nguyen Cu Trinh Ward</p>
                <p>District 1, Ho Chi Minh City, Vietnam</p>
              </div>
              <div>
                <p className="font-medium text-white/80 mb-1">Branch Office</p>
                <p>K&M Tower, 33 Ung Van Khiem, Ward 25</p>
                <p>Binh Thanh District, Ho Chi Minh City</p>
              </div>
              <div>
                <p>
                  <a href="mailto:contact@apolo.com.vn" className="hover:text-accent transition-colors">
                    contact@apolo.com.vn
                  </a>
                </p>
                <p>
                  <a href="tel:+84903419479" className="hover:text-accent transition-colors">
                    +84 903 419 479
                  </a>
                </p>
              </div>
